        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              ...
              это целое искусство. И{" "}
              <strong>
                моей мечтой с 2021 было создать сервис, который бы убрал всех посредников между экспертом и его
                клиентом.
              </strong>{" "}
              Извините, специалисты, если вы это читаете, это не относится к вам лично — это моя персональная боль и
              мечта.
            </p>
            ...
            <blockquote className="border-l-4 border-primary pl-4 sm:pl-6 italic text-base sm:text-lg text-muted-foreground my-8">
              ...
              <br />
              Чтобы сервисы были только такие, в которых сможет разобраться любой человек без бутылки водки и чтобы для
              них не нужно было искать специально обученного человека.
              <br />
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              Я в полнейшем смысловом кризисе.{" "}
              <strong>
                Через 3 года я пойму, что мы всегда знаем свои истинные желания, и если в них не идем — начинается
                пи*дец.
              </strong>{" "}
              Как раз в этот момент выхожу из всех чатов инфобизнеса, думаю, что больше не хочу заниматься курсами.
              Ставлю на обои на телефоне коллаж из Дурова, Цукерберга, Безоса и Джобса. Я четко знаю: мне туда! В
              технологии. И мне всего для этого хватает. Кроме навыков разработки.
            </p>
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              И у меня даже есть идея. Я все еще хочу, чтобы создание и продажа онлайн-проектов стали простыми.{" "}
              <strong>
                Я устала контролировать каждую мелочь в проектах, и хочу, чтобы тексты писались сами, сами отправлялись
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-8">
              В конце 2022 года появляется ChatGPT, и я еще не понимаю, как искусственный интеллект повлияет на мою
              жизнь и профессию. Как и все, вбиваю туда простые вопросы, чтобы понять, он вообще работает?
            </p>
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              ...
              подрядчиков 9 месяцеы, результат примерно никакой. Много ошибок, багов, в итоге мы даже не выгружаем
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              Не долго думая, я соглашаюсь. Помогаю проекту, отдаю свою методологию, развиваю проект, продумываю каждую
              деталь, веду сообщество проекта. В первый же месяц продаж окупается год разработки. За первые 6 месяцев
              проект зарабатывает уже 85 000 000 руб.
            </p>

            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              А я понимаю: это все-таки чужой проект. На мои идеи и предложения ребята отвечают: мы не видим в этом
              миллиардов. На мою идею строить платформу, которая упростит людям работу: это очень долго и дорого, мы не
              хотим распыляться. У меня нет права голоса в проекте, я не зарабатываю с проекта, при этом посвящаю ему
              много времени и сил.
            </p>

            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              Мучительные раздумья — и я прекращаю работу с проектом. Я не могу больше вкладывать свои силы, мозги и
              аудиторию в чужое.
            </p>

            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-8">
              Решаю двигаться в IT дальше — но уже самостоятельно. Сразу же начинаю разработку платформы своей мечты. Но
              дело идет медленно. На каждый чих нужен свой специалист: дизайнер (160 000 руб. в месяц), продакт-менеджер
              (80-150 000 руб. в месяц), тестировщик, прототипировщик, верстальщик, разработчик (500 000 руб. в месяц),
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              Летом 2025 года знакомый показывает мне вайбкодинг. Он появился только в 2025 году. Мои эмоции: я
            ...
            <ul className="space-y-2 mb-8 list-none">
              {[
                "2 500 руб. в месяц",
                "от 2 000 руб. в месяц в зависимости от того, сколько много ты в них создаешь. Я создаю очень много — поэтому плачу 10 000 руб. в месяц.",
              ].map((item, idx) => (
                <li key={idx} className="relative pl-6 text-base sm:text-lg leading-relaxed text-muted-foreground">
                  <span className="absolute left-0 top-3 w-2 h-2 rounded-full bg-gradient-to-r from-primary to-accent"></span>
                  {item}
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-8">
              Оля Гогаладзе создала по моим промтам и рекомендациям сервис для своей команды, который помогает
            ...
            <ul className="space-y-2 mb-6 list-none">
              {[
                "Присылать красивые сайты-отчеты после консультаций",
                "Создать личный кабинет, где будет храниться все",
                "Размещать свои курсы и проекты",
                "Создавать сервисы, которые повышают средний чек, выделяют из конкурентов, делают вашу услугу или обучение более удобным и наглядным",
              ].map((item, idx) => (
                <li key={idx} className="relative pl-6 text-base sm:text-lg leading-relaxed text-muted-foreground">
                  <span className="absolute left-0 top-3 w-2 h-2 rounded-full bg-gradient-to-r from-primary to-accent"></span>
                  {item}
            ...
            <ul className="space-y-2 mb-6 list-none">
              {[
                "Сделать воронку продаж через тест (дает конверсию до 10-15% в покупку от всех зашедших). Например, тест на дефициты.",
                "Создать автоматические планы питания на красивом сайте для разных ситуаций клиентов — и они будут отмечать вас в сториз",
                "Сделать своего бота с ИИ, который будет помогать клиентам придерживаться правил — и они будут советовать вас друзьям",
                "Создать красивый трекер привычек — и давать его за подписку на ваш аккаунт",
                "Создать воронку-калькулятор, из нее конверсия в продажу от 4 до 10% от всех зашедших — и поднять продажи",
                "Сделать личный кабинет для каждого клиента, где лежат его персональные планы, рекомендации — и стать клиентоориентированнее 99% нутрициологов",
                "Повысить продажи, за счет того что каждый клиент обрабатывается через искусственный интеллект, и ему выдается персональное руководство — и тратить на это 10 минут.",
                "Сделать страничку с автоматическим списком здоровых покупок, бесплатную — и за счет этого набрать +10 тыс новых подписчиков через рилз.",
                "Создать своего бота с поддержкой клиентов 24/7 вместо вас — и сэкономить часы жизни.",
              ].map((item, idx) => (
                <li key={idx} className="relative pl-6 text-base sm:text-lg leading-relaxed text-muted-foreground">
                  <span className="absolute left-0 top-3 w-2 h-2 rounded-full bg-gradient-to-r from-primary to-accent"></span>
                  {item}
            ...
            <ul className="space-y-2 mb-8 list-none">
              {[
                ...
                "Сервис по радостным событиям, которые ты делаешь для себя",
                "Интерактивный генератор сказок",
                "Развивающие игры для малышей с персонажами — ими же",
                "Семейный дашборд: списки покупок, визиты к врачу, школьное расписание, кружки — все в одном месте",
                "Бот семейной хроники, который задает 1 вопрос в день и формирует семейную книгу воспоминаний",
              ].map((item, idx) => (
                <li key={idx} className="relative pl-6 text-base sm:text-lg leading-relaxed text-muted-foreground">
                  <span className="absolute left-0 top-3 w-2 h-2 rounded-full bg-gradient-to-r from-primary to-accent"></span>
                  {item}
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-8">
              ...
              на свою платформу, которые помогают идти к большому видению: чтобы между экспертом и покупателем больше не
              нужны были посредники. Дополнительный бюджет, команда… Чтобы это стало простым и доступным, и талантливый
              человек мог много зарабатывать, даже не будучи предпринимателем, руководителем и управленцем от природы.
            </p>
            ...
            <ol className="space-y-6 mb-8 list-none counter-reset">
              {[
                "Это базовый современный навык, он должен быть у каждого члена команды. Уже 8 месяцев мы прощаемся с членами команды, которые не пользуются искусственным интеллектом для ускорения и упрощения своей работы. Через пару месяцев в команде не останется тех, кто не умеет вайбкодить, потому что с помощью этого можно решить любую задачу. То есть, это способ не потерять свою работу в принципе.",
                "Сейчас огромная конкуренция среди всех видов специалистов, услуг и обучений. Создать для клиентов дополнительную ценность: дашборды, красивые отчеты, сервисы — это способ выделиться из всех. Сейчас этого не делает практически НИКТО.",
                "Сэкономить миллионы рублей на разработке. Это не преувеличение. Если вы пойдете в серьезную разработку, то миллион рублей в месяц, это минимум, который будет уходить на команду: дизайнер, продакт, разработчик. Сервисы стоят 2 000-10 000 руб. в месяц.",
                "Сэкономить время на разработке. Раньше на то, на что сейчас уходит 3 дня, уходило 3 месяца. Я НЕ ПРЕУВЕЛИЧИВАЮ.",
                ...
                "Разрабатывать такое на заказ как услугу. Даже если вы будете брать за это сотни тысяч рублей — раньше бизнес платил за это миллионы. Это уже будет экономия.",
                "Поднять чек на свою услугу — за счет того, что с навыком вайбкодинга вы можете сильно улучшить продукт для клиента. Когда я разбираю с учениками, что они могут сделать с помощью искусственного интеллекта для клиентов, я каждый раз слышу: это ж я могу минимум в 2 раза теперь поднимать стоимость!",
                "Оказывать услуги для бизнеса. Сейчас кризис, и бизнес только и хочет, что снизить расходы, повысить доходы и эффективность. На это способен ТОЛЬКО ИСКУССТВЕННЫЙ ИНТЕЛЛЕКТ. А точнее — человек с AI-first мышлением, который умеет и вайбкодить, и агентов писать, и понимать, что именно и как сделать. Сейчас это самая ходовая услуга. Большинство предпринимателей имеют настолько низкую чистую прибыль, что зарабатывают меньше своих сотрудников. Так быть не должно, и вы сможете стать человеком, который это исправит.",
                "Если вы продюсер — то это необходимый навык, без которого в течение года вас уже не будет на рынке. Тут и говорить не о чем. Уметь снижать расходы, увеличивать эффективность с помощью ИИ — мастхев. Современная база, как раньше прогревы.",
              ].map((item, idx) => (
                <li
                  key={idx}
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              Я прошла путь от нуля до создания коммерческой платформы — не просто делаю игрушечные проекты, а строю
              реальный бизнес.
            </p>

            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              Мой опыт в продажах на 1,5 млрд руб помогает создавать не просто красивые интерфейсы, а то, что продает. У
              меня насмотренность и навыки дизайнера — мои проекты не выглядят как типичные сайты из конструктора.
            </p>

            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              Я знаю все ловушки разработки — потеряла 50 млн на неудачных проектах, чтобы вы не повторили моих ошибок.
            </p>

            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              Фокус на монетизации — учу не просто кодить, а зарабатывать с первых проектов.
            </p>

            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              За 11 лет опыта в бизнесе и продажах, 11 лет опыта в дизайне, 3 года активного использования
              искусственного интеллекта в работе и жизни, 2 года опыта создания IT-проектов и их успешной монетизации, я
              вывела свой подход.
            </p>
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              У меня накопилось действительно много опыта и своих личных фишек и лайфхаков: как делать красиво, не
              шаблонно, как создавать реальные проекты для клиентов, а не только для себя, как потом это переносить на
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              У меня еще День рождения на носу — 33 года. Делала опрос в своем тг-канале, собрала ВСЕ пожелания. Так что
              в честь Дня рождения — ждите невероятно вкусное предложение.
            </p>

            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-8">
              Я создала этот гайд, потому что хочу, чтобы больше людей почувствовали ту свободу, которую чувствую я.
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-12">
              <strong>PS:</strong> Через 6-12 месяцев этот навык будет стандартом. Сейчас еще можно быть среди первых
              5%, кто использует это преимущество. Через год осваивать этот навык — догонять остальных 95%, у которых он
              есть.
            </p>
          </div>
        </article>
