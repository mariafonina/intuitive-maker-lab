      ...
      <main className="pt-24 sm:pt-32 px-4 sm:px-6 lg:px-8">
        <article className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
              Кстати, вот оно —{" "}
              <a href="https://talkscore.club" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">
                talkscore.club
              </a>
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">Я прошла путь от нуля до создания коммерческой платформы — строю реальный бизнес через вайбкодинг.</p>

            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">Мой опыт в продажах на 1,5 млрд руб помогает создавать и красивые интерфейсы, и то, что продает. У меня насмотренность и навыки дизайнера.</p>

            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">Я знаю все ловушки разработки — потеряла 50 млн на неудачных проектах, и это сумма, которую вы сможете сэкономить.</p>

            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">Фокус на монетизации — понятно, что именно делать, чтобы зарабатывать с первых проектов.</p>
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-4">Мой подход состоит из:</p>
            <ul className="space-y-2 mb-6 list-none">
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">У меня еще День рождения на носу — 33 года. Делала опрос в своем тг-канале, собрала ВСЕ пожелания. Так что в честь Дня рождения — ждите вкусное предложение.</p>
