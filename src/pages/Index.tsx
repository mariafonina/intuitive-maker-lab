...
Серьезно, я бы занималась ТОЛЬКО ЭТИМ.</p>
            ...
            <h3 className="text-2xl sm:text-3xl font-bold mt-12 mb-6">Первые попытки в IT</h3>
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">
            ...
            <h3 className="text-2xl sm:text-3xl font-bold mt-12 mb-6">Знакомство с вайбкодингом</h3>
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">Летом 2025 знакомый показывает мне вайбкодинг. Он появился только в 2025 году. Мои эмоции: я разработала платформу за 3 часа, на которую у меня уходило несколько месяцев!</p>

            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-8">
              Сейчас все мои знакомые предприниматели, кто имел дело с IT, говорят: <strong>
— Если бы я знал и умел это раньше, я бы сэкономил миллионы, десятки миллионов, сотни миллионов рублей…</strong>
            </p>
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground mb-6">Присылать красивые сайты-отчеты после консультаций.
Создать личный кабинет, где будет храниться все. Размещать свои курсы и проекты. Создавать сервисы, которые повышают средний чек, выделяют из конкурентов, делают вашу услугу или обучение более удобным и наглядным.</p>
